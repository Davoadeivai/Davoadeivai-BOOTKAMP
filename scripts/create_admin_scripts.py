...
def main():
    ...
    default_username = '382132701c4733c3402706cfdd3c8fc7f41f80a88dce5428d145259a41c5f12f'
    default_password = '382132701c4733c3402706cfdd3c8fc7f41f80a88dce5428d145259a41c5f12f'

    if not User.exists_user('Milad'):
        ...
        print("The default admin user 'Milad' already exists.")
